...
Route::get('book-publiser/{id}', 'User\BookController@nxb')->name('publiser-detail');
Route::get('book-detail/{id}', 'User\BookDetailController@index')->name('book-detail');
Route::post('book-detail-vote/{id}', 'User\BookDetailController@voteBook')->name('book-detail-vote');
Route::get('book-read/{id}', 'User\BookDetailController@readBook')->name('book-read');
