				...
				<div class="row">
						...
						<div class="shop-left">
							...
							<div class="cate">	
                                <ul class="list-group list-group-flush">
                                     @foreach ($cate as $ca)
                                        <li  class="list-group-item"> <a href="#" id = "myulli">{{$ca->category_name}}</a> </li>
                                     @endforeach
                                 </ul>           
							</div>
							<div class="section-title-5 mb-30">
							...
							<div class="publiser-detail">
                                <ul class="list-group list-group-flush">
                                    @foreach ($pub as $pub)
                                    <li  class="list-group-item">  <a href="{{ route('publiser-detail', $pub->id) }}" id = "myulli">{{$pub->publisher_name}}</a></li>
                                 @endforeach
                                  </ul>
							</div>
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
						<div class="section-title-5 mb-30">
                            ...
                            <h3 class="text-center mb-4">Nhà xuất bản :{{ $publisher->publisher_name }} ({{ $publisher->books->count() }})</h3>
						</div>
						<!-- tab-area-start -->
